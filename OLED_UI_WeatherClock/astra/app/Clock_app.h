...
namespace astra {
    ...
    public:
        ...
        enum SelectedItemCLockTimeSetting {TimeHour,TimeMinute,TimeSecond};
        enum SelectedItemCLockDateSetting {DateYear,DateMonth,DataDay};
    ...
    public:
        ...
        void StopwatchPopup(std::string _info);
    private:
        // 时间更新逻辑（新增数字分解）
        void updateTime();
    public:
