...
public:
  ...
  static unsigned char getFontWidth(const std::string &_text) { return get()->_getFontWidth(_text); }

  virtual unsigned char _getFontWidth(const std::string &_text) { return 0; }
  ...
  static void setClipRect(int _x, int _y, int _w, int _h) {
    get()->_setClipRect( _x,  _y,  _w,  _h);
  }
  virtual void _setClipRect(int _x, int _y, int _w, int _h){}

  static void resetClipRect(){get()->_resetClipRect();}
  virtual void _resetClipRect(){}
...
public:
  ...
  static void wifiConnect(const char* _wifista_ssid,
    const char* _wifista_password)
  { get()->_wifiConnect( _wifista_ssid, _wifista_password); }

  virtual void _wifiConnect(const char* _wifista_ssid,
    const char* _wifista_password) {}


  static void wifiDisConnect(){ get()->_wifiDisConnect(); }

  virtual void _wifiDisConnect() {}
